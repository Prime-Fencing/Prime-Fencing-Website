	...
	if ( $googleMaps.length ) {
		$googleMaps.each(function() {
			...
			geocoder.geocode({
				...
				var ottawaBounds = {
				  north: 45.55, // Latitude limit for the northern edge of Ottawa
				  south: 45.25, // Latitude limit for the southern edge of Ottawa
				  east: -75.5, // Longitude limit for the eastern edge of Ottawa
				  west: -76 // Longitude limit for the western edge of Ottawa
				};
...
var legendContent = "<h3 style='margin-top: 0;'>Legend</h3>" +
  ...
  "<img src='images/map/map_marker_icon.png' alt='Marker Icon' style='margin-right: 5px; width: 20px; height: 20px;'>" +
  "<span style='vertical-align: middle; font-size: 12px;'>Chainlink</span>" +
  "</div>" +
  "<div style='display: flex; align-items: center; margin-bottom: 5px;'>" +
  "<img src='images/map/map_marker_icon2.png' alt='Marker Icon' style='margin-right: 5px; width: 20px; height: 20px;'>" +
  "<span style='vertical-align: middle; font-size: 12px;'>Iron</span>" +
  "</div>" +
  "<div style='display: flex; align-items: center; margin-bottom: 5px;'>" +
  "<img src='images/map/map_marker_icon3.png' alt='Marker Icon' style='margin-right: 5px; width: 20px; height: 20px;'>" +
  `<span style='vertical-align: middle; font-size: 12px;'>  Polyvinyl Chloride (PVC)</span>`+
  "</div>" +
  "<div style='display: flex; align-items: center; margin-bottom: 5px;'>" +
  "<img src='images/map/map_marker_icon4.png' alt='Marker Icon' style='margin-right: 5px; width: 20px; height: 20px;'>" +
  "<span style='vertical-align: middle; font-size: 12px;'>Wood</span>" +
  "</div>";
